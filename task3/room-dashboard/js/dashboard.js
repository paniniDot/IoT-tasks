  ...
  lightButton.addEventListener("click", () => {
    lightswitch.addEventListener("click", () => {
      if (lightButton.checked) {
        axios.post('http://localhost:8080/api/data_from_client', createJson("light", lightswitch.checked ? 1 : 0));
    ...
    axios.post('http://localhost:8080/api/data_from_client', createJson("manual_light", lightButton.checked ? 1 : 0));
  });
  ...
  rollButton.addEventListener("click", () => {
    ...
    range.addEventListener('input', (event) => {
      if(rollButton.checked) {
        ...
        axios.post('http://localhost:8080/api/data_from_client', createJson("roll", value))
    ...
    axios.post('http://localhost:8080/api/data_from_client', createJson("manual_roll", rollButton.checked ? 1 : 0));
  });
});