...
public class ArduinoUi extends JFrame {
	...
	public void setupGraph(final String title, final String xLabel, final String yLabel, final XYDataset dataset) {
		this.graph = ChartFactory.createXYLineChart(title, xLabel, yLabel, dataset, PlotOrientation.VERTICAL, true,
				false, false);
	}

	public void setupSlider(final boolean connected, final SerialInputListener listener) {
